...
gltfloader.load('./assets/cabin/cabin.gltf', (gltfScene)=>{
scene.add(gltfScene.scene)
})
gltfloader.load('./assets/cabindoor/cabindoor.gltf', (gltfScene2)=>{
...
var snowAlpha = new THREE.TextureLoader().load('./assets/textures/snowAlpha.png');
